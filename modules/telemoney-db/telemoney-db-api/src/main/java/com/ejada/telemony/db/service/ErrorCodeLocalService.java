...
public interface ErrorCodeLocalService extends BaseLocalService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.ejada.telemony.db.service.impl.ErrorCodeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the error code local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ErrorCodeLocalServiceUtil} if injection and service tracking are not available.
	 */
