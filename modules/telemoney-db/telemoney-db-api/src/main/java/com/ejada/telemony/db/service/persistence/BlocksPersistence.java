...
/**
 * The persistence interface for the blocks service.
 *
 * <p>
 ...
 */
@ProviderType
public interface BlocksPersistence extends BasePersistence<Blocks> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BlocksUtil} to access the blocks persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<Blocks> findByChannelId(long channelId);
	 ...
	 */
	public java.util.List<Blocks> findByChannelId(
	...
	public java.util.List<Blocks> findByChannelId(
		long channelId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Blocks>
			orderByComparator);
	 ...
	 */
	public void cacheResult(java.util.List<Blocks> blockses);
	 ...
	 * @return the blockses
	 */
	public java.util.List<Blocks> findAll();
	 ...
	 */
	public java.util.List<Blocks> findAll(int start, int end);
