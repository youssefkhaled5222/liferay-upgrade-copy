...
/**
 * Provides the local service interface for Channels. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ChannelsLocalServiceUtil
 * @generated
 */
@OSGiBeanProperties(
	property = {"model.class.name=com.ejada.telemony.db.model.Channels"}
)
@ProviderType
@Transactional(
...
public interface ChannelsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.ejada.telemony.db.service.impl.ChannelsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the channels local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ChannelsLocalServiceUtil} if injection and service tracking are not available.
	 */
	public Channels add(
	...
	public Channels addChannels(Channels channels);
	...
	public Channels createChannels(long channelId);
	...
	public Channels deleteChannels(Channels channels);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Channels deleteChannels(long channelId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Channels fetchChannels(long channelId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Channels getChannels(long channelId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Channels> getChannelses(int start, int end);
