...
/**
 * Provides the local service interface for UserLogs. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UserLogsLocalServiceUtil
 * @generated
 */
@OSGiBeanProperties(
	property = {"model.class.name=com.ejada.telemony.db.model.UserLogs"}
)
@ProviderType
@Transactional(
...
public interface UserLogsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.ejada.telemony.db.service.impl.UserLogsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the user logs local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link UserLogsLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public UserLogs createUserLogs(long logsId);
	...
	public UserLogs deleteUserLogs(long logsId) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public UserLogs deleteUserLogs(UserLogs userLogs);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserLogs fetchUserLogs(long logsId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserLogs getUserLogs(long logsId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<UserLogs> getUserLogses(int start, int end);
