...
/**
 * Provides the local service interface for FeatureLovMap. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FeatureLovMapLocalServiceUtil
 * @generated
 */
@OSGiBeanProperties(
	property = {"model.class.name=com.ejada.telemony.db.model.FeatureLovMap"}
)
@ProviderType
@Transactional(
...
public interface FeatureLovMapLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.ejada.telemony.db.service.impl.FeatureLovMapLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the feature lov map local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FeatureLovMapLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public FeatureLovMap addFeatureLovMap(FeatureLovMap featureLovMap);
	...
	public FeatureLovMap createFeatureLovMap(long id);
	...
	public FeatureLovMap deleteFeatureLovMap(FeatureLovMap featureLovMap);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public FeatureLovMap deleteFeatureLovMap(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FeatureLovMap fetchFeatureLovMap(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FeatureLovMap getFeatureLovMap(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FeatureLovMap> getFeatureLovMaps(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public FeatureLovMap updateFeatureLovMap(FeatureLovMap featureLovMap);
