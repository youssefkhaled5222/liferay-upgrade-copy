...
/**
 * Provides the local service interface for ConfigurationEntity. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ConfigurationEntityLocalServiceUtil
 * @generated
 */
@OSGiBeanProperties(
	property = {
		"model.class.name=com.ejada.telemony.db.model.ConfigurationEntity"
	}
)
@ProviderType
@Transactional(
...
public interface ConfigurationEntityLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.ejada.telemony.db.service.impl.ConfigurationEntityLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the configuration entity local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ConfigurationEntityLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ConfigurationEntity addConfigurationEntity(
		ConfigurationEntity configurationEntity);

	public String callService(
		ConfigurationEntity configurationEntity, ServiceContext serviceContext);
	...
	public ConfigurationEntity createConfigurationEntity(long id);
	...
	public ConfigurationEntity deleteConfigurationEntity(
		ConfigurationEntity configurationEntity);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ConfigurationEntity deleteConfigurationEntity(long id)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ConfigurationEntity fetchConfigurationEntity(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ConfigurationEntity getConfigurationEntity(long id)
		throws PortalException;
	...
	public void handleConfigurationChange(
			String url, JSONObject oldData, JSONObject newData, String action,
			String entityType, String entityId, ServiceContext serviceContext,
			User user)
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ConfigurationEntity updateConfigurationEntity(
		ConfigurationEntity configurationEntity);

	public ConfigurationEntity updateStatus(
			long userId, long id, int status, ServiceContext serviceContext)
		throws JSONException, NoSuchConfigurationEntityException;
