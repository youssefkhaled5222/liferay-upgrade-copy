...
@ProviderType
public interface AppEnvironment extends AppEnvironmentModel, PersistedModel {
	 ...
	 */
	public static final Accessor<AppEnvironment, Long> ENVIRONMENT_ID_ACCESSOR =
		new Accessor<AppEnvironment, Long>() {

			@Override
			public Long get(AppEnvironment appEnvironment) {
			...
			@Override
			public Class<AppEnvironment> getTypeClass() {
