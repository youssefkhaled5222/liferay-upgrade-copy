...
/**
 * Provides the local service interface for Languages. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LanguagesLocalServiceUtil
 * @generated
 */
@OSGiBeanProperties(
	property = {"model.class.name=com.ejada.telemony.db.model.Languages"}
)
@ProviderType
@Transactional(
...
public interface LanguagesLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.ejada.telemony.db.service.impl.LanguagesLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the languages local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link LanguagesLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public void addNewLanguage(
			...
			boolean primaryLanguage, User user, ServiceContext serviceContext)
		throws Exception;
	...
	public Languages createLanguages(long languageId);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Languages deleteLanguages(long languageId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Languages fetchLanguages(long languageId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Languages> getByLangName(String langName, Long channeld)
		throws Exception;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Languages> getByLocal(String local, Long channeld)
		throws Exception;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Languages getLanguages(long languageId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Languages> getLanguageses(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Map<Languages, Boolean> getLatestApprovedByChannelIdWithPending(
		long channelId);
	...
	public void languageDelete(
			Long id, ServiceContext serviceContext, User user)
		throws Exception;

	public void languageUpdate(
			Long id, String langName, String local, Long channelId,
			boolean primaryLanguage, ServiceContext serviceContext, User user)
		throws Exception;
