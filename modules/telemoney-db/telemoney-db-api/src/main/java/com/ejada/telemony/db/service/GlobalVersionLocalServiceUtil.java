...
/**
 * Provides the local service utility for GlobalVersion. This utility wraps
 * <code>com.ejada.telemony.db.service.impl.GlobalVersionLocalServiceImpl</code> and
 ...
 * @generated
 */
public class GlobalVersionLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.ejada.telemony.db.service.impl.GlobalVersionLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static GlobalVersion addGlobalVersion(GlobalVersion globalVersion) {
		return getService().addGlobalVersion(globalVersion);
	}
	 ...
	 */
	public static GlobalVersion createGlobalVersion(long versionId) {
		return getService().createGlobalVersion(versionId);
	}
	 ...
	 */
	public static GlobalVersion deleteGlobalVersion(
		GlobalVersion globalVersion) {

		return getService().deleteGlobalVersion(globalVersion);
	}
	 ...
	 */
	public static GlobalVersion deleteGlobalVersion(long versionId)
		throws PortalException {

		return getService().deleteGlobalVersion(versionId);
	}
	...
	public static GlobalVersion fetchGlobalVersion(long versionId) {
		return getService().fetchGlobalVersion(versionId);
	}
	...
	public static long getCurrentVersion(
		...
		return getService().getCurrentVersion(
	 ...
	 * @throws PortalException if a global version with the primary key could not be found
	 */
	public static GlobalVersion getGlobalVersion(long versionId)
		throws PortalException {

		return getService().getGlobalVersion(versionId);
	}
	 ...
	 */
	public static List<GlobalVersion> getGlobalVersions(int start, int end) {
		return getService().getGlobalVersions(start, end);
	}
	 ...
	 */
	public static int getGlobalVersionsCount() {
		return getService().getGlobalVersionsCount();
	}
	 ...
	 */
	public static GlobalVersion incrementApprovedVersion(
		long companyId, long channelId, String componentName) {

		return getService().incrementApprovedVersion(
			companyId, channelId, componentName);
	}
	 ...
	 */
	public static GlobalVersion updateGlobalVersion(
		GlobalVersion globalVersion) {

		return getService().updateGlobalVersion(globalVersion);
	}

	public static GlobalVersionLocalService getService() {
		return _service;
	}

	public static void setService(GlobalVersionLocalService service) {
		_service = service;
	}

	private static volatile GlobalVersionLocalService _service;
