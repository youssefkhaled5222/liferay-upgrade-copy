...
import com.ejada.telemony.db.service.base.OTPLocalServiceBaseImpl;
 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>com.ejada.telemony.db.service.OTPLocalService</code> interface.
 *
 * <p>
...
public class OTPLocalServiceImpl extends OTPLocalServiceBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Use <code>com.ejada.telemony.db.service.OTPLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ejada.telemony.db.service.OTPLocalServiceUtil</code>.
	 */
...
//			 Set the "Authorization" header with Basic Authentication
	...
	public String getAllOTPEvents(String portalApiUrl,String XCorrelationId,String userName,String password) {
	...
	public void updateOTPEvent(String requestParam1, String requestParam2,
								  String requestParam3, String requestParam4, String portalApiUrl, OtpRequestDto otpRequestDto
			                     , OtpRequestDto oldData, String XCorrelationId, ServiceContext serviceContext , User user) throws PortalException, JsonProcessingException {


		JSONObject updatePayload = JSONFactoryUtil.createJSONObject();
		updatePayload.put(requestParam1, otpRequestDto.getEventCode());
		updatePayload.put(requestParam2, otpRequestDto.getEventReasonAr());
		updatePayload.put(requestParam3, otpRequestDto.getEventReasonEn());
		updatePayload.put(requestParam4, otpRequestDto.getEventDescription());

		JSONObject oldDataJson = JSONFactoryUtil.createJSONObject();
		oldDataJson.put(requestParam1, oldData.getEventCode());
		oldDataJson.put(requestParam2, oldData.getEventReasonAr());
		oldDataJson.put(requestParam3, oldData.getEventReasonEn());
		oldDataJson.put(requestParam4, oldData.getEventDescription());

		serviceContext.setAttribute("xCorrelationId", XCorrelationId);
		configurationEntityLocalService.handleConfigurationChange(portalApiUrl,oldDataJson,updatePayload, Constants.UPDATE_OTP,Constants.OTP, otpRequestDto.getEventCode(),serviceContext, user);
		 callServiceUpdate(portalApiUrl, updatePayload,XCorrelationId );
	}
	...
	public void handleApprovedConfigEntity(ConfigurationEntity configurationEntity, ServiceContext serviceContext) throws JSONException {
		...
		if (action.equals(Constants.UPDATE_OTP)) {
			LOG.info("Handling update otp event request for URL: " + configurationEntity.getUrl() + " with data: " + configurationEntity.getNewData());
