...
/**
 * The arguments resolver class for retrieving value from Themes.
 *
...
@OSGiBeanProperties(
	property = {
		"class.name=com.ejada.telemony.db.model.impl.ThemesImpl",
		"table.name=THEMES"
	},
	service = ArgumentsResolver.class
)
public class ThemesModelArgumentsResolver implements ArgumentsResolver {
	...
	public String getClassName() {
		return ThemesImpl.class.getName();
	}

	@Override
	public String getTableName() {
		return ThemesTable.INSTANCE.getTableName();
	}
