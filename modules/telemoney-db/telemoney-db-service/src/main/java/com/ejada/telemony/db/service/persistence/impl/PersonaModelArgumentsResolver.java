...
/**
 * The arguments resolver class for retrieving value from Persona.
 *
...
@OSGiBeanProperties(
	property = {
		"class.name=com.ejada.telemony.db.model.impl.PersonaImpl",
		"table.name=PERSONA"
	},
	service = ArgumentsResolver.class
)
public class PersonaModelArgumentsResolver implements ArgumentsResolver {
	...
	public Object[] getArguments(
		...
		if (finderPathColumnBitmask == null) {
			...
			for (String columnName : columnNames) {
				finderPathColumnBitmask |= personaModelImpl.getColumnBitmask(
					columnName);
			}
	...
	public String getClassName() {
		return PersonaImpl.class.getName();
	}

	@Override
	public String getTableName() {
		return PersonaTable.INSTANCE.getTableName();
	}
