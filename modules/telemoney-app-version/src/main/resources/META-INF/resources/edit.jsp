...
<%
  AppVersion record = (AppVersion) request.getAttribute("record");

  String errorMsg = (String) request.getAttribute("errorMsg") != null
          ? (String) request.getAttribute("errorMsg")
          : "";

  String platform = record != null ? record.getPlatform() : "";
  String versionNumber = record != null ? record.getVersionNumber() : "";
  String url = record != null ? record.getUrl() : "";
  Boolean status = record != null ? record.getAppVersionStatus() : true;
%>



<div>
  <h3 class="pb-4">Edit App Version</h3>
...
<%--  <% } %>--%>
  <div class="card">
    <div class="card-body">
      <form action="<%=editAppVersion%>" method="post"
            name="<portlet:namespace/>editAppVersionForm"
            id="<portlet:namespace/>editAppVersionForm">
 ...
 title="Special characters like < > ' &quot; are not allowed." class="form-control"
                  ...
                  id="<portlet:namespace/>platform" disabled>
...
<aui:script>
  ...
  boundingBox: '#<portlet:namespace/>editAppVersionForm',
  rules: {
